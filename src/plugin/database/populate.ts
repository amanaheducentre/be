...
async function populateDatabase() {
  ...
  try {
    ...
    const lectures = [
      ...
      // Course 3 - Section 3 (Flutter Widgets)
      {
        id: generateId(),
        courseId: courseId3,
        sectionId: sectionIds[16],
        type: "video",
        title: "Stateless vs Stateful Widgets",
        description: "Memahami perbedaan dan kapan menggunakan masing-masing widget",
        durationSeconds: 1440,
        isPreview: false,
        sortOrder: 1,
        status: "published",
      ...
      },
      {
        ...
        sectionId: sectionIds[16],
        type: "video",
        title: "Layout Widgets: Column, Row, Stack",
        description: "Membuat layout dengan Flutter layout widgets",
      ...
      },
      {
        ...
        description: "Membuat scrollable lists dan grids",
      ...
      },
      {
        ...
        description: "Navigasi antar screens di Flutter",
      ...
      // Course 4 - Data Science sections
      {
        id: generateId(),
        courseId: courseId4,
        sectionId: sectionIds[20] || generateId(),
        type: "video",
        title: "Introduction to Python for Data Science",
        description: "Overview Python libraries untuk data science",
        durationSeconds: 900,
        isPreview: true,
        sortOrder: 1,
        status: "published",
      ...
      },
      {
        ...
        description: "Bekerja dengan NumPy arrays untuk numerical computing",
        durationSeconds: 1500,
        isPreview: false,
        sortOrder: 2,
        status: "published",
      ...
      },
      {
        ...
        description: "Memahami dan memanipulasi data dengan Pandas",
        durationSeconds: 1800,
        isPreview: false,
        sortOrder: 3,
        status: "published",
      ...
      },
      {
        ...
        description: "Membersihkan missing values dan outliers",
      ...
      },
      {
        ...
        sectionId: sectionIds[20] || generateId(),
        type: "video",
        title: "Data Visualization dengan Matplotlib",
        description: "Membuat charts dan plots dengan Matplotlib",
        durationSeconds: 1440,
        isPreview: false,
        sortOrder: 5,
        status: "published",
      ...
      },
      {
        ...
        sectionId: sectionIds[20] || generateId(),
        type: "video",
        title: "Advanced Visualization dengan Seaborn",
        description: "Statistical plots dengan Seaborn",
      ...
      // Course 5 - Machine Learning sections
      {
        id: generateId(),
        courseId: courseId5,
        sectionId: sectionIds[21] || generateId(),
        type: "video",
        title: "Machine Learning Introduction",
        description: "Apa itu ML dan berbagai jenis pembelajaran",
        durationSeconds: 1080,
        isPreview: true,
        sortOrder: 1,
        status: "published",
      ...
      },
      {
        ...
        description: "Implementasi linear regression manual",
      ...
      },
      {
        ...
        description: "Binary dan multiclass classification",
      ...
      },
      {
        ...
        description: "Tree-based models untuk classification dan regression",
      ...
      },
      {
        ...
        description: "Memahami perceptrons dan neural networks",
      ...
      },
      {
        ...
        description: "Build dan train neural networks dengan TensorFlow",
      ...
      },
      {
        ...
        sectionId: sectionIds[21] || generateId(),
        type: "video",
        title: "Computer Vision dengan CNN",
        description: "Convolutional Neural Networks untuk image recognition",
